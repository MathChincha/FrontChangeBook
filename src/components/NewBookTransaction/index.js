...
export default function NewBookTransaction({navigation}){
    ...
    return(
        ...
        <Modal 
            ...
            <View style={styles.modal}>
                ...
                <View style={styles.modalTexts}>
                <Text style={{color:"#fff"}}>Nome do Dono: {oldOwner.user_name}</Text>
                </View>
                <View style={styles.modalTexts}>
                <Text style={{color:"#fff"}}>Cidade: {oldOwner.city}</Text>
                </View>
                <View style={styles.modalTexts}>
                <Text style={{color:"#fff"}}>Telefone: {oldOwner.phone}</Text>
                </View>
                <View style={styles.modalTexts}>
                <Text style={{color:"#fff"}}>Email: {oldOwner.email}</Text>
                </View>
